...
void uselessVoid() {
  if (useless_var < 2) {
    gb.gui.popup("Nothing ...",75);
  }
  if (useless_var >= 2 && useless_var < 4 ) {
    gb.gui.popup("Please stop ...",75);
  }
  if (useless_var >= 4 && useless_var < 6) {
    gb.gui.popup("You're obstinate ... ",75);
  }
  if (useless_var >= 6 && useless_var < 8) {
    gb.gui.popup("Well well well ...",75);
  }
  if (useless_var >= 8) {
    gb.gui.popup("Useless, really !",75);
  }
}
